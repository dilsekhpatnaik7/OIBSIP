      ...
      <main className='bg-white dark:bg-gray-900'>
        <section className='px-10'>
          <nav className='py-10 flex justify-between'>
            ...
            <ul className='ml-5 flex px-10 items-center'>
              <li><BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer text-2xl text-gray-900 dark:text-teal-100' /></li>
...
to higher positions</p>
        ...
        <section>
          ...
          <div className='text-5xl flex justify-center gap-16 text-gray-800 cursor-pointer dark:text-teal-300'>
            <div className='m-2 text-5xl grid grid-cols-5 gap-10 justify-items-center text-gray-800 dark:text-teal-300'>
            <SiCplusplus/>
            <SiJava/>
            <SiPython/>
            <AiFillHtml5/>
